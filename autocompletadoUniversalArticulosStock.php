			...
			$num_query_articulos=mysql_num_rows($query);
					...
					{ 
						...
						if ($search==$assoc_query_articulos['art_cod'] and $num_search>=3) 
							{
								...
								echo "<script>
								<!--
								location.href='stock.php?ID_art=".$assoc_query_articulos['ID_art']."';
								//-->
								</script>";
						...
						{	
								...
								if ($num_search>=3)
								{
								echo "<a href='stock.php?ID_art=".$assoc_query_articulos['ID_art']."'>

										<div class='suggest-element' id='suggest-element' style='text-align:left'>
												<button class='btn btn-info' id='articulos' name='articulos' style='height: auto; width: 100%; margin-top: 30px; text-align:center;'>
													<div class='col-md-12'>
