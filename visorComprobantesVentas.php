...
<?php
  ...
  $fecHasta=$fechaFinFormateda . " 23:59:59";
                        ...
                        if ($ID_tceB==0) 
                        {
                          $get_comprobantes=$comprobantesE->get_cabecera_comprobantes_listado_ventas($fecDesde, $fecHasta);
                          $get_comprobantesB=$comprobantesE->get_cabecera_comprobantes_listado_ventas_totales($fecDesde, $fecHasta);
                        }
                        else
                        {
                          $get_comprobantes=$comprobantesE->get_cabecera_comprobantes_listado_ventas_ID_tceB($ID_tceB, $fecDesde, $fecHasta);
                          $get_comprobantesB=$comprobantesE->get_cabecera_comprobantes_listado_ventas_ID_tceB_totales($ID_tceB, $fecDesde, $fecHasta);
                        }  
                        if ($get_comprobantes) 
                        {
                                  ...
                                  if ($cpd_original==0) 
                                  {
                                    ...
                                    else
                                    {
                                      echo '<tr>';
                                        ...
                                        echo '<th>ORIGINAL</th>';
                                        echo '<th><a href="verComprobantes.php?ID_cte='.$ID_cte.'"><button class="btn btn-info"><i class="material-icons">visibility</i></button></a></th>';
                  ...
                  echo '<div class="alert alert-dismissible alert-success">
                          <h4><strong>TOTAL VENDIDO:</strong> $ '.$total_sin_descuentos.'</h4>
                        </div>';     
