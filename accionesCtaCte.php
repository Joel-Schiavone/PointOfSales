      ...
      echo "<div class='col-md-12' id='mostradorDeDatosDeCliente' style='text-align:center; margin-top:2%;'>"; 
        ...
        { 
          ...
          $assoc_get_clientes_byNombreYApellido=mysql_fetch_assoc($get_clientes_byNombreYApellido);
                         ...
                         echo "<div class='col-md-3' style='cursor:pointer'>"; 
                          echo '<div class="panel panel-info">';
                              ...
                              echo '<div class="panel-body">';
                                  ...
                                  echo '<input hidden type="text" id="cli_nombre" name="cli_nombre" value="'.$assoc_get_clientes_byNombreYApellido['cli_apellido']. ' '.$assoc_get_clientes_byNombreYApellido['cli_nombre'].'">';
